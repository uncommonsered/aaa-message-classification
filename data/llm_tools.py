...
SYSTEM_PROMPT_SPAM = """Ты аугментируешь сообщения для датасета модерации. Для каждого сообщения можешь:
- слегка осовремень текст
- сохрани написание слов с опечатками или намеренными искажением
- добавить ссылки на Telegram/WhatsApp или @username, t.me
